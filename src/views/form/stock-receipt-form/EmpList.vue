<template>
<b-card title="STOCK RECEIPT FORM">
    ...
    <b-row class="">
        <b-col cols="12" md="6">
            <div class="d-flex flex-column">
                    <b-form-group class="w-100" label="P.O No" label-for="po-no">
                        <b-form-select id="po-no" class="d-inline-block w-100 mr-1" :options="['Canada','United States']"/>
                    </b-form-group>
                    ...
                    <b-form-group class="w-100" label="Company" label-for="company">
                        <b-form-select id="company" class="d-inline-block w-100 mr-1" :options="['Canada','United States']"/>
                    </b-form-group>
    ...
    <b-row class="mb-2">
        <b-col cols="12" md="6">
                    <b-form-group class="w-100" label="Vendor Details" label-for="vendor">
                        <b-form-select id="vendor" class="d-inline-block w-100" :options="['Vendor 1','Vendor 2','Vendor 3','Vendor 4','Vendor 5']"/>
                    </b-form-group>
                    <div class="d-flex flex-column align-items-start justify-content-start mb-3">
                        <p class="mb-1">Vendor Name</p>
                        <p class="mb-1">Vendor Address 1</p>
                        <p class="mb-1">Vendor Address 2</p>
                        <p class="mb-1">Vendor City</p>
                        <p class="mb-1">Vendor Country</p>
                        <p class="mb-1">Vendor TRN</p>
                    </div>
        </b-col> 
        <b-col cols="12" md="6">
                <div class="d-flex flex-column justify-content-end align-items-end">
                  ...
                  <b-form-group class="w-50" label="Delivery Date" label-for="delivery-date">
                        <b-form-datepicker id="delivery-date" v-model="delivery_date" placeholder="Choose a date" local="en" />
                  </b-form-group>
                </div>
        </b-col> 
    </b-row>
    ...
    data() {
        return {
            ...
            fields: [
                ...
                {
                    key: 'joining_date',
                    label: 'Existing Quantity In Stock',
                },
                {
                    key: 'nationality',
                    label: 'New Quantity after receipt',
                },
                {
                    key: 'total',
                    label: 'Average Price of stock item',
                },
            ],
            items: [],
            status: [{
