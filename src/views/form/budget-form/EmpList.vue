...
<b-card title="BUDGET FORM">
    ...
    <b-row class="">
        <b-col cols="12" md="6">
            <div class="d-flex flex-column">
                    <b-form-group class="w-100" label="Choose Level" label-for="choose-level">
                        <b-form-select id="choose-level" class="d-inline-block w-100 mr-1" :options="['Cost Center','Branch','Company']"/>
                    </b-form-group>
            </div>
        </b-col>
        <!-- <b-col cols="12" md="6">
    ...
    <b-row class="">
        <b-col cols="12" md="6">
            <div class="d-flex flex-column">
                    <b-form-group class="w-100" label="Choose Period" label-for="choose-period">
                        <b-form-select id="choose-period" class="d-inline-block w-100 mr-1" :options="['Monthly','Quarterly','Semi-Annual','Annual']"/>
                    </b-form-group>
            </div>
        </b-col>
        <!-- <b-col cols="12" md="6">
        ...
        <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
                ...
                <b-button variant="primary" @click="isAddNewUserSidebarActive = true">
                    <span class="text-nowrap">Add Details</span>
                </b-button>
            </div>
        </b-col>
    </b-row>
