            ...
            <b-form ref="myForm" class="p-2" @submit.prevent="handleSubmit(addEmployee)" >
                ...
                <validation-provider #default="validationContext" name="Account" rules="required">
                    <b-form-group label="Account" label-for="Account">
                        <b-form-input id="Account" v-model="item_name" :state="getValidationState(validationContext)" trim />
                ...
                <validation-provider #default="validationContext" name="TYPE" rules="required">
                    <b-form-group label="TYPE" label-for="TYPE">
                        <b-form-input id="TYPE" v-model="item_discription" :state="getValidationState(validationContext)" trim />
                ...
                <validation-provider #default="validationContext" name="CLASS" rules="required">
                    <b-form-group label="CLASS" label-for="CLASS">
                        <b-form-input id="CLASS" v-model="item_code" :state="getValidationState(validationContext)" trim />
