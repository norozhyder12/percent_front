<template>
<b-card title="PETTY CASH REQUEST FORM">
    ...
    <b-row class="mb-5">
        <b-col cols="12" md="6">
            <div class="d-flex flex-column">
                    <b-form-group class="w-100" label="Employee Name" label-for="employee name">
                        <b-form-select id="employee name" class="d-inline-block w-100 mr-1" :options="['John','Smith']"/>
                    </b-form-group>
                    ...
                    <b-form-group class="w-100" label="Job Title" label-for="job-title">
                        <b-form-select id="job-title" class="d-inline-block w-100 mr-1" :options="['CEO','Assistant Manager']"/>
                    </b-form-group>
            </div>
        </b-col>
        <b-col cols="12" md="6">
