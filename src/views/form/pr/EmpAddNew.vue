    ...
    <template #default="{ hide }">
        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
            ...
            <b-form ref="myForm" class="p-2" @submit.prevent="handleSubmit(addEmployee)" >
                ...
                <validation-provider #default="validationContext" name="ITEM DISCRIPTION" rules="required">
                    <b-form-group label="ITEM DISCRIPTION" label-for="ITEM DISCRIPTION">
                        <b-form-input id="ITEM DISCRIPTION" v-model="item_discription" :state="getValidationState(validationContext)" trim />
                ...
                <validation-provider #default="validationContext" name="ITEM QUANTIY" rules="required">
                    <b-form-group label="ITEM QUANTIY" label-for="ITEM QUANTIY">
                        <b-form-input id="ITEM QUANTIY" v-model="item_quantity" :state="getValidationState(validationContext)" trim />
