    ...
    <template #default="{ hide }">
        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
            ...
            <b-form ref="myForm" class="p-2" @submit.prevent="handleSubmit(addEmployee)" >
                ...
                <validation-provider #default="validationContext" name="AMOUNT TO RELEASE" rules="required">
                    <b-form-group label="AMOUNT TO RELEASE" label-for="AMOUNT TO RELEASE">
                        <b-form-input id="AMOUNT TO RELEASE" v-model="item_quantity" :state="getValidationState(validationContext)" trim />
