            ...
            <b-form class="p-2" @submit.prevent="handleSubmit(EditEmployee)">
                ...
                <validation-provider #default="validationContext" name="Payee NAME" rules="required">
                    <b-form-group label="Payee NAME" label-for="Payee NAME">
                        <b-form-input id="Payee NAME" v-model="myemp.full_name" :state="getValidationState(validationContext)" trim />
                ...
                <validation-provider #default="validationContext" name="Phone">
                    <b-form-group label="Phone" label-for="Phone">
                        <b-form-input id="Phone" v-model="myemp.phone" :state="getValidationState(validationContext)" trim />
                ...
                <!-- Username -->
                <validation-provider #default="validationContext" name="designation">
                    <b-form-group label="designation" label-for="designation">
                        <b-form-input id="designation" v-model="myemp.designation" :state="getValidationState(validationContext)" trim />
    ...
    methods: {
        EditEmployee() {
            const mydata = {
                ...
                phone: this.$props.myemp.phone,
                designation: this.$props.myemp.designation,
            }
            const mythis = this
            axios
                .post(`/payees/update/${this.$props.myemp.id}`,
                    mydata)
                .then(response => {
