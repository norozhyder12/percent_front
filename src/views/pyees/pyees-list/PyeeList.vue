<template>
<b-card title="Payees List">
    <PyeeAddNew :is-add-new-user-sidebar-active.sync="isAddNewUserSidebarActive" @refetch-data="fetchEmps" />
    <PyeeEdit v-if="currentEdit != null" :is-edit-user-sidebar-active.sync="isEditUserSidebarActive" :myemp="currentEdit" @refetch-data="fetchEmps" />
    <b-row class="mb-2">
...
import PyeeAddNew from './PyeeAddNew'
import PyeeEdit from './PyeeEdit'
...
export default {
    ...
    methods: {
       async UpdateStatus(id) {
            await axios
                .post(`/customers/changeStatus/` + id, {
