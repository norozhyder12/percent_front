    ...
    <template #default="{ hide }">
        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
            ...
            <b-form class="p-2" @submit.prevent="handleSubmit(addEmployee)">
                ...
                <!-- Username -->
                <validation-provider #default="validationContext" name="EXPENSE NAME" rules="required">
                    <b-form-group label="EXPENSE NAME" label-for="EXPENSE NAME">
                        <b-form-input id="EXPENSE NAME" v-model="exp_name" :state="getValidationState(validationContext)" trim />
