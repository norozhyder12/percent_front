<template>
<b-card title="Expenses Types">
    <expensetypeAddNew :is-add-new-user-sidebar-active.sync="isAddNewUserSidebarActive" @refetch-data="fetchEmps" />
    <expensetypeEdit v-if="currentEdit != null" :is-edit-user-sidebar-active.sync="isEditUserSidebarActive" :myemp="currentEdit" @refetch-data="fetchEmps" />
    <b-row class="mb-2">
...
import expensetypeAddNew from './expensetypeAddNew'
...
export default {
    ...
    methods: {
       async UpdateStatus(id) {
            await axios
                .post(`/expensetypes/changeStatus/` + id, {
