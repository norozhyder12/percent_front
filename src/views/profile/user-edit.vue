...
<b-card ref="mytabs">
    <b-tabs v-if="userData" pills>
        ...
        <b-tab active>
            ...
            <useredittabaccount :user-data="userData" class="mt-2 pt-75" @reset="fetchUser(userData.id)" />
        </b-tab>
        ...
        <b-tab>
            ...
            <UserEditTabInformation :user-data="userData.business_info" class="mt-2 pt-75" @reset="fetchUser(userData.id)" />
        </b-tab>
         <b-tab>
            <template #title>
                <feather-icon icon="PhoneIcon" size="16" class="mr-0 mr-sm-50" />
                <span class="d-none d-sm-inline">Contact Persons</span>
            </template>
            <ContactPersons :user-data="userData" class="mt-2 pt-75" />
        </b-tab>
    </b-tabs>
</b-card>
</template>
