...
<b-card title="My Settlements">
    <b-row class="mb-2">
        ...
        <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
                ...
                <b-button variant="primary" @click="$router.push({ name: 'upload-settlement' })">
                    <span class="text-nowrap">Add Settlement</span>
                </b-button>
            </div>
        </b-col>
    </b-row>
  ...
  <template #cell(total_value)="data">
                ...
                <template #cell(actions)="data">
                    ...
                    <div @click="$router.push({name:'settlement-view',params:{id:data.item.id}})">
                        <feather-icon icon="EyeIcon" />
                        <span class="align-middle ml-50">Details</span>

                    </div>
                    <div @click="$router.push({name:'settlement-edit',params:{id:data.item.id}})">
...
export default {
    ...
    methods: {
        myRowClickHandler(record) {
          this.$router.push({ name: 'settlement-view', params: { id: record.id } })
        },
               moneyFormat(money) {
