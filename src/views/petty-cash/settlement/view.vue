...
<div v-if="mybill != null">
    <div title="Settlement Info">
        <b-row class="bill_info">
            <b-col md="4">
                <statistic-card-horizontal icon="HashIcon" :statistic="'#'+mybill.id" statistic-title="Settlement ID" />
            </b-col>
            <b-col md="4">
                <statistic-card-horizontal icon="DollarSignIcon" :statistic="moneyFormat(mybill.items.reduce(function (acc, obj) { return acc + parseFloat(obj.total_value); }, 0) )" statistic-title="Settlement Total" />
            </b-col>
            <b-col md="4">
                <b-card>
            ...
            <b-col md="6">
                <b-card>
                    <div style="justify-content: space-between;    align-items: center;">
                        <label class="d-block"><span style="font-size:18px;font-weight:bold;">Supplier</span></label>
             ...
             <b-col md="6">
                <b-card>
                    <div style="display:flex;justify-content: space-between;    align-items: center;">
                        <label><span style="font-size:18px;font-weight:bold;">Payee</span></label>
 {{ mybill.payee.full_name}}
                    </div>
