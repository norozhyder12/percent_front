...
<script>
import uploadform from '@/components/uploadSettlement/upload-form'
 ...
 watch: {
    ...
    methods: {
        submitUpload(data) {
            ...
            formDataObj.append('payee_id', data.payee.id)
            ...
            axios
                .post(`/settlements/add/`, formDataObj, {
                ...
                .then(response => {
                    ...
                    this.myloader.close()
                    this.$router.push('/settlements/list')
