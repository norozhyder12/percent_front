    ...
    <b-card title="Actions">
        <b-row class="mt-4 mb-2">
            ...
            <b-col cols="12" md="6" lg="6" class="text-right">
                <b-button size="lg" variant="outline-secondary" class="mr-4" @click="$router.push('/bills')">
                    Cancel
                </b-button>
...
<script>
import EditItem from '@/components/upload/items/edititem.vue'
    ...
    methods: {
        ...
        UpdateBill() {
            ...
            for (var i = 0; i < this.mybill.files.length; i++) {
                if (!this.mybill.files[i].bill_id) {
            ...
            axios
                .post(`/bills/update/` + this.mybill.id, formDataObj, {
                ...
                .then(response => {
                    ...
                    this.myloader.close()
                    this.$router.push('/bills/view/' + this.mybill.id)
