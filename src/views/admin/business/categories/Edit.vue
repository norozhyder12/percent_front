    ...
    <template #default="{ hide }">
        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
            ...
            <b-form class="p-2" @submit.prevent="handleSubmit(EditEmployee)">
                ...
                <!-- Username -->
                <validation-provider #default="validationContext" name="TYPE NAME" rules="required">
                    <b-form-group label="TYPE NAME" label-for="TYPE NAME">
                        <b-form-input id="TYPE NAME" v-model="myemp.name" :state="getValidationState(validationContext)" trim />
...
export default {
    ...
    methods: {
        EditEmployee() {
            ...
            const mythis = this
            axios
                .post(`/business-categories/update/${this.$props.myemp.id}`,
                    mydata)
                .then(response => {
