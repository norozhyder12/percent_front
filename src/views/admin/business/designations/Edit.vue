    ...
    <template #default="{ hide }">
        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
            ...
            <b-form class="p-2" @submit.prevent="handleSubmit(EditEmployee)">
                ...
                <!-- Username -->
                <validation-provider #default="validationContext" name="Designations NAME" rules="required">
                    <b-form-group label="Designations NAME" label-for="Designations NAME">
                        <b-form-input id="Designations NAME" v-model="myemp.name" :state="getValidationState(validationContext)" trim />
...
export default {
    ...
    methods: {
        EditEmployee() {
            ...
            const mythis = this
            axios
                .post(`/business-contact-des/update/${this.$props.myemp.id}`,
                    mydata)
                .then(response => {
