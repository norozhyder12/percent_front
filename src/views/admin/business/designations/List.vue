<template>
<b-card title="Business Contact Designation">
    <AddNewDialog :is-add-new-user-sidebar-active.sync="isAddNewUserSidebarActive" @refetch-data="fetchEmps" />
    <EditDialog v-if="currentEdit != null" :is-edit-user-sidebar-active.sync="isEditUserSidebarActive" :myemp="currentEdit" @refetch-data="fetchEmps" />
    <b-row class="mb-2">
        ...
        <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
                ...
                <b-button variant="primary" @click="isAddNewUserSidebarActive = true">
                    <span class="text-nowrap">Add Designations</span>
                </b-button>
            </div>
        </b-col>
    </b-row>
                ...
                
{
    ...
    methods: {
         async UpdateStatus(id) {
            await axios
                .post(`/business-contact-des/changeStatus/` + id, {
