            ...
            <b-form class="p-2" @submit.prevent="handleSubmit(addEmployee)">
                ...
                <validation-provider #default="validationContext" name="Designations NAME" rules="required">
                    <b-form-group label="Designations NAME" label-for="Designations NAME">
                        <b-form-input id="Designations NAME" v-model="type_name" :state="getValidationState(validationContext)" trim />
