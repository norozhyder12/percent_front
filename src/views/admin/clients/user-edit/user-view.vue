...
<b-card ref="mytabs">
    ...
    <b-tabs v-if="userData" pills>
        ...
        <b-tab>
            ...
            <UserEditTabInformation :isdisable="true" :user-data="userData" class="mt-2 pt-75" @reset="fetchUser(userData.id)" />
        </b-tab>

         <b-tab>
            <template #title>
                <feather-icon icon="InfoIcon" size="16" class="mr-0 mr-sm-50" />
                <span class="d-none d-sm-inline">Bills</span>
            </template>
        </b-tab>
        <b-tab>
            <template #title>
         ...
         <b-tab>
            <template #title>
                <feather-icon icon="InfoIcon" size="16" class="mr-0 mr-sm-50" />
                <span class="d-none d-sm-inline">Suppliers</span>
            </template>
        </b-tab>
    </b-tabs>
</b-card>
        ...
        fetchUser(id) {
            ...
            axios
                ...
                .then(response => {
                    ...
                    this.mybusss=this.userData.business_info.business_name
                    this.myloader.close()
                })
                .catch(error => {
                    console.log(error)
