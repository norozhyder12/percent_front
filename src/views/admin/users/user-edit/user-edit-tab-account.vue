...
<div>
                ...
                <b-row>
                    ...
                    <b-col cols="12" md="6">
                        <b-form-group label="Status" label-for="user-status">
                            <v-select v-model="userData.status" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" :options="statusOptions" :reduce="val => val.value" :clearable="false" input-id="user-status" :disabled="isdisable" />
                        </b-form-group>
                    </b-col>
                    ...
                    <b-col cols="12" md="6">
                        <b-form-group label="User Role" label-for="user-role">
                            <v-select v-model="userData.role" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" :options="roleOptions" :reduce="val => val.value" :clearable="false" input-id="user-role" :disabled="isdisable" />
                        </b-form-group>
                    </b-col>
                </b-row>
            </b-col>
    ...
    <b-row class="mt-2">
        ...
        <b-col v-else>
            <b-button variant="primary" class="mb-1 mb-sm-0 mr-0 mr-sm-1" :to="{ name: 'user-admin-edit', params: { id: userData.id } }" :block="$store.getters['app/currentBreakPoint'] === 'xs'">
                Edit
            </b-button>
        </b-col>
    </b-row>
