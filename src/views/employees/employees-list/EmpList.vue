<template>
<b-card title="Employees List">
    <EmpAddNew :is-add-new-user-sidebar-active.sync="isAddNewUserSidebarActive" :role-options="roleOptions" @refetch-data="fetchEmps" />
    <EmpEdit v-if="currentEdit != null" :is-edit-user-sidebar-active.sync="isEditUserSidebarActive" :myemp="currentEdit" @refetch-data="fetchEmps" />
    <b-row class="mb-2">
