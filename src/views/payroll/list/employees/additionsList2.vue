...
<div>
    <b-row class="mb-2">
        ...
        <b-col cols="12" md="12" class="d-flex align-items-center justify-content-end">
            <div>
                <b-button size="md" variant="light" v-b-modal.modaladds>
                    <span class="text-nowrap">Add Addition</span>
                </b-button>
            </div>
            <b-modal id="modaladds" ref="modaladds" centered title="Add Addition" hide-footer @ok="addItem">
...
export default {
    ...
    methods: {
        hidedailog() {
            this.$refs['modaladds'].hide()
        },
          DeleteEmp(id) {
            this.boxOne = ''
            this.$bvModal
                .msgBoxConfirm('Please confirm that you want to delete this Additions.', {
        ...
        DeleteEmpHard(id) {
            axios
                .post(`/payroll-employees/additions/delete/` + id, {
