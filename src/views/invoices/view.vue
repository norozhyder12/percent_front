...
<div v-if="mybill != null">
    <div title="Invoice Info">
        <b-row class="bill_info">
            <b-col>
                <statistic-card-horizontal icon="HashIcon" :statistic="'#'+mybill.id" statistic-title="Invoice ID" />
            </b-col>
            <b-col>
                <statistic-card-horizontal icon="DollarSignIcon" :statistic="moneyFormat(mybill.total_invoice)" statistic-title="Invoice Total" />
            </b-col>
            <b-col>
                <b-card>
            ...
            <b-col>
                <b-card>
                    <div style="justify-content: space-between;    align-items: center;">
                        <label class="d-block"><span style="font-size:18px;font-weight:bold;">Customer</span></label>

                          {{ mybill.my_customer.name}}
                    </div>
