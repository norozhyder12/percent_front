...
<div class="main-menu menu-fixed menu-accordion menu-shadow" :class="[
    ...
    <vue-perfect-scrollbar :settings="perfectScrollbarSettings" class="main-menu-content scroll-area" tagname="ul" @ps-scroll-y="evt => { shallShadowBottom = evt.srcElement.scrollTop > 0 }">
        <vertical-nav-menu-items v-if="myuser.role != 'admin'" :items="navMenuItems.filter(obj => obj.admin != true)" class="navigation navigation-main" />
        <vertical-nav-menu-items v-else :items="navMenuItems.filter(obj => obj.admin != false)" class="navigation navigation-main" />
